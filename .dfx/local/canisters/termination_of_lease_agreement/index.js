...
import { idlFactory } from './termination_of_lease_agreement.did.js';
export { idlFactory } from './termination_of_lease_agreement.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TERMINATION_OF_LEASE_AGREEMENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./termination_of_lease_agreement.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the termination_of_lease_agreement canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./termination_of_lease_agreement.did.js")._SERVICE>}
 */
export const termination_of_lease_agreement = createActor(canisterId);
